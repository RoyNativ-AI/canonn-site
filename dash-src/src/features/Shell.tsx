  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="lg:pl-[224px]">
        ...
        <footer className="mx-auto flex w-full max-w-[1100px] flex-wrap items-center gap-x-5 gap-y-1.5 px-5 pt-2 pb-8 font-mono text-[10.5px] text-muted-foreground sm:px-8">
